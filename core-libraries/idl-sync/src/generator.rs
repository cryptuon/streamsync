...
use crate::{
    ...
    types::{
        ...
        InstructionBehaviorPattern, AccountRequirement,
    },
};
...
impl IDLGenerator {
    ...
    pub async fn generate_idl_definition(
        ...
        Ok(IDLDefinition {
            ...
            accounts,
            types,
            events: vec![], // TODO: implement event generation
            errors: vec![], // TODO: implement error generation
            constants: vec![], // TODO: implement constant generation
        })
    }
